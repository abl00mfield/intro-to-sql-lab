...
WHERE countrylanguages.isofficial = true
GROUP BY countries.code, countries.name
HAVING COUNT(*) = 1 AND MAX(countrylanguages.language) = 'Italian';
...
FROM 
    cities 
JOIN 
    countries ON cities.countrycode = countries.code 
WHERE 
